...
function _enqueue_scripts() {
    ...
    wp_enqueue_script( 'jquery-core', get_stylesheet_directory_uri() . '/js/jquery-3.3.1.min.js' );
    ...
    wp_enqueue_script( 'datatable-core-js', 'https://cdn.datatables.net/1.10.11/js/jquery.dataTables.js' );
    wp_enqueue_script( 'datatable-buttons-js', 'https://cdn.datatables.net/buttons/1.1.2/js/dataTables.buttons.js' );
    wp_enqueue_script( 'datatable-select-js', 'https://cdn.datatables.net/select/1.1.2/js/dataTables.select.js' );
    wp_enqueue_script( 'datatable-responsive-js', 'http://cdn.datatables.net/responsive/2.0.2/js/dataTables.responsive.js' );
    wp_enqueue_script( 'datatable-js', get_stylesheet_directory_uri() . '/js/data-table-editor.js' );
    wp_enqueue_script( 'custom-core-js', get_stylesheet_directory_uri() . '/js/init.js' );
