    ...
    <header>
        ...
        <div class="sidebar-fixed position-fixed">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="http://localhost/juncture/dashboard/users/" class="list-group-item list-group-item-action waves-effect">
                    <i class="fas fa-user mr-3"></i>Users</a>
                <a href="http://localhost/juncture/dashboard/transaction/" class="list-group-item active waves-effect">
